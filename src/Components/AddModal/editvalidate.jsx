...
export function validateFormEdit(formValues, fieldTemplates, currentType) {
  ...
  fields.forEach((field) => {
    ...
    // 🔑 In edit mode, relax requirements for password and picture
    if (field.name === "password" || field.type === "picture") {
      isRequired = false;
    }
